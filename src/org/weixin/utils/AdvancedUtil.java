...
import org.weixin.domain.token.SNSUserInfo;
import org.weixin.domain.token.WeixinGroup;
import org.weixin.domain.token.WeixinMedia;
import org.weixin.domain.token.WeixinOauth2Token;
import org.weixin.domain.token.WeixinQRCode;
import org.weixin.domain.token.WeixinUserInfo;
import org.weixin.domain.token.WeixinUserList;
...
public class AdvancedUtil {
	...
	public static String getQRCode(String ticket, String savePath) {
		...
		requestUrl = requestUrl.replace("TICKET", CommonUtil.toUTF8(ticket));
		try {
	...
	public static WeixinMedia uploadMedia(String accessToken, String type, String mediaFileUrl) {
		...
		try {
			...
			// 根据内容类型判断文件扩展名
			String fileExt = CommonUtil.getFileType(contentType);
			// 请求体开始
	...
	public static String getMedia(String accessToken, String mediaId, String savePath) {
		...
		try {
			...
			// 根据内容类型获取扩展名
			String fileExt = CommonUtil.getFileType(conn.getHeaderField("Content-Type"));
			// 将mediaId作为文件名
